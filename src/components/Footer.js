    ...
    return(
        ...
        <div className="container-fluid mt-5 align-items-end" style={{backgroundColor: "#3581B8", color: "white"}}>
            <div className="row container">
                <img src="https://junerpagal.com/images/images/site-logo.png" style={{width: "60px", borderTopLeftRadius: "50%", borderBottomRightRadius: "50%"}} alt="..."/>
            ...
            <div className="row">
                ...
                <div className="col-md-3 p-4">
                    ...
                    <div className="mt-3 text-center">
                        <p className="text-center fs-5">Our Social Media</p>
                        <ul>
